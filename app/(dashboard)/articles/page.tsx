    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-dark-text-secondary">
            Create and manage article specifications, materials, and production stages.
          </p>
        </div>
        <Button onClick={() => setActiveTab("create")} className="bg-dark-accent hover:bg-dark-accent-hover">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="bg-dark-surface border-dark-border">
          <TabsTrigger value="list" className="data-[state=active]:bg-dark-accent">
            Article Variants
          </TabsTrigger>
          <TabsTrigger value="create" className="data-[state=active]:bg-dark-accent">
            Create Variant
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="list" className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {filteredVariants.map((variant) => (
              <Card key={variant.id} className="bg-dark-surface border-dark-border">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <Package className="h-5 w-5 text-dark-accent" />
                      <CardTitle className="text-dark-text">{variant.id}</CardTitle>
                    </div>
                  ...
                  <CardDescription className="text-dark-text-secondary">{variant.baseName}</CardDescription>
                </CardHeader>
                <CardContent className="space-y-3">
                  <div>
                    <Label className="text-sm text-dark-text-secondary">Variant Details</Label>
                    <div className="flex flex-wrap gap-1 mt-1">
                      <Badge variant="secondary" className="bg-dark-bg text-dark-text">
                        {variant.color}
                      </Badge>
                      <Badge variant="secondary" className="bg-dark-bg text-dark-text">
                        Size {variant.size}
                  ...
                  <div>
                    <Label className="text-sm text-dark-text-secondary">Materials ({variant.materials.length})</Label>
                    <div className="flex flex-wrap gap-1 mt-1">
                      {variant.materials.slice(0, 3).map((material) => (
                        <Badge key={material} variant="outline" className="border-dark-border text-dark-text-secondary">
                          {material}
                        </Badge>
                      ))}
                      {variant.materials.length > 3 && (
                        <Badge variant="outline" className="border-dark-border text-dark-text-secondary">
                          +{variant.materials.length - 3} more
                        </Badge>
                      )}
                    </div>
                  </div>
                  <div>
                    <Label className="text-sm text-dark-text-secondary">Stages ({variant.stages.length})</Label>
                    <div className="flex flex-wrap gap-1 mt-1">
                      {variant.stages.slice(0, 2).map((stage) => (
                        <Badge key={stage} variant="outline" className="border-dark-border text-dark-text-secondary">
                          {stage}
                        </Badge>
                      ))}
                      {variant.stages.length > 2 && (
                        <Badge variant="outline" className="border-dark-border text-dark-text-secondary">
                          +{variant.stages.length - 2} more
                        </Badge>
                      )}
                    </div>
                  </div>
        ...
        <TabsContent value="create" className="space-y-6">
          <Card className="bg-dark-surface border-dark-border">
            <CardHeader>
              <CardTitle className="text-dark-text">Create New Article Variant</CardTitle>
              <CardDescription className="text-dark-text-secondary">
                Define article variant specifications, required materials, and production stages.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label className="text-dark-text">Article Base</Label>
                  <Select value={formData.baseId} onValueChange={handleBaseChange}>
                    ...
                    <SelectContent className="bg-dark-surface border-dark-border">
                      {articleBases.map((base) => (
                        <SelectItem key={base.id} value={base.id} className="text-dark-text">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent className="bg-dark-surface border-dark-border">
                      {colors.map((color) => (
                        <SelectItem key={color} value={color} className="text-dark-text">
                          {color}
                        </SelectItem>
                      ))}
                    </SelectContent>
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent className="bg-dark-surface border-dark-border">
                      {sizes.map((size) => (
                        <SelectItem key={size} value={size} className="text-dark-text">
                          {size}
                        </SelectItem>
                      ))}
                    </SelectContent>
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent className="bg-dark-surface border-dark-border">
                      {genders.map((gender) => (
                        <SelectItem key={gender} value={gender} className="text-dark-text">
                          {gender}
                        </SelectItem>
                      ))}
                    </SelectContent>
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent className="bg-dark-surface border-dark-border">
                      {sides.map((side) => (
                        <SelectItem key={side} value={side} className="text-dark-text">
                          {side}
                        </SelectItem>
                      ))}
                    </SelectContent>
              ...
              <div className="space-y-4">
                <Label className="text-dark-text">Required Raw Materials</Label>
                ...
                {formData.materials.length > 0 && (
                  <div className="flex flex-wrap gap-1">
                    {formData.materials.map((material) => (
                      <Badge key={material} variant="secondary" className="bg-dark-accent text-white">
                        {material}
                        <button onClick={() => toggleMaterial(material)} className="ml-1 hover:text-red-300">
                          ×
                        </button>
                      </Badge>
                    ))}
              ...
              {/* Work Stages */}
              <div className="space-y-4">
                <Label className="text-dark-text">Production Work Stages</Label>
                ...
                {formData.stages.length > 0 && (
                  <div className="flex flex-wrap gap-1">
                    {formData.stages.map((stage) => (
                      <Badge key={stage} variant="secondary" className="bg-dark-accent text-white">
                        {stage}
                        <button onClick={() => toggleStage(stage)} className="ml-1 hover:text-red-300">
                          ×
                        </button>
                      </Badge>
                    ))}
              ...
              {/* Notes */}
              <div className="space-y-2">
                <Label className="text-dark-text">Additional Notes</Label>
                <Textarea
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="bg-dark-surface border-dark-border max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-dark-text">Edit Article Variant</DialogTitle>
            <DialogDescription className="text-dark-text-secondary">
              Modify the article variant specifications and settings.
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent className="bg-dark-surface border-dark-border">
          <DialogHeader>
            <DialogTitle className="text-dark-text">Delete Article Variant</DialogTitle>
            <DialogDescription className="text-dark-text-secondary">
              Are you sure you want to delete this article variant? This action cannot be undone.
            </DialogDescription>
          </DialogHeader>
          <div className="flex gap-4 pt-4">
